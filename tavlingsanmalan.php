...
<html lang="sv">
  <head>
    ...
    <title>Anmälan Vårbollen - SJTK</title>
    <link rel="stylesheet" href="regvarbollen.css">
  </head>
  <body>
    <div class="registration-container">
      <div class="registration-card">
        ...
        <?php else: ?>
          ...
          <img src="images/varbollen.png" alt="Vårbollen" class="registration-image"/>

          <div class="tournament-name">Vårbollen 2026</div>

          <div class="registration-form-container">
            <h3 class="form-title">Anmälan till Vårbollen 2026</h3>
        ...
        <div class="navigation-buttons">
          ...
          <a class="nav-button" href="https://www.sjtk.se/vardubbel.html">Till Vårbollens sidan</a>
        </div>
      </div>
    </div>
    <script>
